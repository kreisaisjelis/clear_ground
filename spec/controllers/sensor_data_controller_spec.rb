...
describe SensorDataController do
  ...
  let(:valid_attributes) { { "sensor" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved sensor_datum as @sensor_datum" do
        ...
        post :create, {:sensor_datum => { "sensor" => "invalid value" }}, valid_session
        assigns(:sensor_datum).should be_a_new(SensorDatum)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested sensor_datum" do
        ...
        SensorDatum.any_instance.should_receive(:update).with({ "sensor" => "MyString" })
        put :update, {:id => sensor_datum.to_param, :sensor_datum => { "sensor" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the sensor_datum as @sensor_datum" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        SensorDatum.any_instance.stub(:save).and_return(false)
        put :update, {:id => sensor_datum.to_param, :sensor_datum => { "sensor" => "invalid value" }}, valid_session
        assigns(:sensor_datum).should eq(sensor_datum)
      end
